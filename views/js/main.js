...
var adjectives = ["dark", "color", "whimsical", "shiny", "noise", "apocalyptic", "insulting", "praise", "scientific"],
    ...
    selectRandomMeat = function() {
        ...
        for (var e = 0; c > e; e++) a += ingredientItemizer(selectRandomNonMeat());
        for (var e = 0; d > e; e++) a += ingredientItemizer(selectRandomCheese());
        return a += ingredientItemizer(selectRandomSauce()), a += ingredientItemizer(selectRandomCrust())
    }, pizzaElementGenerator = function() {
        for (var a = '<div id="pizza0" class="randomPizzaContainer" ><div class="col-md-6"><img src="images/pizza.png" class="img-responsive"></div><div class="col-md-6"><h4>The Udacity Special</h4><ul><li>Turkey</li><li>Tofu</li><li>Cauliflower</li><li>Sun Dried Tomatoes</li><li>Velveeta Cheese</li><li>Red Sauce</li><li>Whole Wheat Crust</li></ul></div></div><div id="pizza1" class="randomPizzaContainer" ><div class="col-md-6"><img src="images/pizza.png" class="img-responsive"></div><div class="col-md-6"><h4>The Cameron Special</h4><ul><li>Chicken</li><li>Hot Sauce</li><li>White Crust</li></ul></div></div>', b = 2; 100 > b; b++) a += '<div class="randomPizzaContainer" id="pizza' + b + '"><div class="col-md-6"><img src="images/pizza.png" class="img-responsive"></div><div class="col-md-6"><h4>' + randomName() + "</h4><ul>" + makeRandomPizza() + "</ul></div></div>";
        return a
        ...
        function c(a, b) {
            ...
            var d = a.offsetWidth,
                e = document.querySelector("#randomPizzas").offsetWidth,
                f = d / e,
                g = c(b),
                h = (g - f) * e;
            return h
        ...
        function d(a) {
            var b = c(document.querySelector(".randomPizzaContainer"), a),
                d = document.querySelector(".randomPizzaContainer").offsetWidth + b + "px";
            document.styleSheets[1].cssRules[7].style.width = d
        }
...
window.performance.mark("mark_start_generating"), document.getElementById("randomPizzas").innerHTML = pizzaElementGenerator(), window.performance.mark("mark_end_generating"), window.performance.measure("measure_pizza_generation", "mark_start_generating", "mark_end_generating");
