...
/*
create one long html string of all the random pizzas. Start with the udacity and cameron pizzas in the string.
*/
var pizzaElementGenerator = function() {
    var pizzaStr = '<div id="pizza0" class="randomPizzaContainer" ><div class="col-md-6"><img src="images/pizza.png" class="img-responsive"></div><div class="col-md-6"><h4>The Udacity Special</h4><ul><li>Turkey</li><li>Tofu</li><li>Cauliflower</li><li>Sun Dried Tomatoes</li><li>Velveeta Cheese</li><li>Red Sauce</li><li>Whole Wheat Crust</li></ul></div></div><div id="pizza1" class="randomPizzaContainer" ><div class="col-md-6"><img src="images/pizza.png" class="img-responsive"></div><div class="col-md-6"><h4>The Cameron Special</h4><ul><li>Chicken</li><li>Hot Sauce</li><li>White Crust</li></ul></div></div>';

  for (var i = 2; i < 100; i++) {
    pizzaStr += '<div class="randomPizzaContainer" id="pizza' + i + '"><div class="col-md-6"><img src="images/pizza.png" class="img-responsive"></div><div class="col-md-6"><h4>' + randomName() + '</h4><ul>' + makeRandomPizza() + '</ul></div></div>';
  }
  return pizzaStr;
}
...
/*
  modify css width rule in style sheet and allow browser to handle the repaint.
*/
  function changePizzaSizes(size) {
    var dx = determineDx(document.querySelector(".randomPizzaContainer"), size);
    var newWidth = (document.querySelector(".randomPizzaContainer").offsetWidth + dx) + 'px';
    document.styleSheets[1].cssRules[7].style.width = newWidth;
  }
...
/*
  Change from a for loop to a bulk innerHTML injection.
*/
document.getElementById("randomPizzas").innerHTML = pizzaElementGenerator();
